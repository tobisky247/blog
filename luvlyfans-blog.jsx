...
const ARTICLES = [
  {
    id: 1,
    slug: "make-10k-first-month",
    category: "Make Money",
    tag: "make-money",
    title: "How to Make Your First $10,000 as a Creator — In Under 30 Days",
    excerpt:
      "The exact playbook 200+ LuvlyFans creators used to hit 5 figures fast.",
    readTime: "8 min",
    author: "Ava Chen",
    authorRole: "Top Creator · $40K/mo",
    authorAvatar: "AC",
    date: "Mar 22, 2026",
    featured: true,
    trending: true,
  ...
  },
  {
    ...
    excerpt:
      "Stop guessing. Here's the data-backed approach to pricing your tiers, PPV, and bundles.",
    readTime: "6 min",
    author: "Marcus Reid",
  ...
  {
    id: 3,
    slug: "get-1000-subscribers",
    category: "Growth",
    tag: "growth",
    title: "Get Your First 1,000 Subscribers Without Buying Ads",
    excerpt:
      "Organic growth tactics that actually work in 2026. Funnels, hooks, and the content formats dominating right now.",
    readTime: "10 min",
    author: "Zoe Park",
  ...
  {
    id: 4,
    slug: "onlyfans-vs-luvlyfans",
    category: "Guides",
    tag: "guides",
    title: "OnlyFans vs LuvlyFans: The Honest Comparison Every Creator Needs",
    excerpt:
      "Platform fees, payout speed, discovery tools, creator support. We break it all down.",
    readTime: "7 min",
  ...
  {
    id: 6,
    slug: "creator-case-study-luna",
    category: "Case Studies",
    tag: "case-studies",
    title: "Case Study: How Luna Made $85K in 6 Months From Zero",
    excerpt:
      "A brutally honest look at the content calendar, promotion strategy, and mindset that fueled her rise.",
    readTime: "15 min",
    author: "Marcus Reid",
    authorRole: "Creator Coach",
    authorAvatar: "MR",
...
const HUB_MODULES = [
  {
    ...
    guides: [
      {
        title: "Setting Up Your Page for Maximum First Impressions",
        time: "5 min",
      },
  ...
  },
  {
    ...
    guides: [
      {
        title: "Building a Content Calendar That Keeps Fans Addicted",
        time: "10 min",
      },
...
const COMPARISON = {
  ...
  rows: [
    { feature: "Platform Fee", values: ["10%", "20%", "20%", "15%"] },
    {
      ...
      values: ["24–48 hrs", "7–21 days", "7 days", "7 days"],
    },
    {
      feature: "Creator Discovery",
      values: ["✓ Built-in", "✗ None", "Limited", "Limited"],
    },
    {
      feature: "Analytics Dashboard",
      values: ["Advanced", "Basic", "Basic", "Basic"],
    },
    {
      feature: "Referral Program",
      values: ["5% lifetime", "5% (1yr)", "✗", "5% (1yr)"],
    },
    { feature: "Direct Messaging", values: ["✓", "✓", "✓", "✓"] },
    { feature: "Live Streaming", values: ["✓", "✓", "✗", "✓"] },
    {
      feature: "Creator Support",
      values: ["Dedicated", "Email only", "Email only", "Email only"],
    },
    {
      feature: "Content Diversity",
      values: ["All niches", "All niches", "All niches", "Limited"],
    },
  ],
};
            ...
            <div>
              <div
                style={{
                  fontSize: 12,
                  fontWeight: 600,
                  color: dark ? "rgba(255,255,255,0.8)" : "#0f0f0f",
                }}
              >
                {article.author}
              </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        ...
        >
          Join 12,000+ creators getting our weekly strategies, case studies, and
          insider growth tactics. No spam. Unsubscribe anytime.
        </p>
        {done ? (
          <div
            style={{
        ...
        >
          ★★★★★ 4.9 rating · Trusted by 12,000+ creators
        </div>
      </div>
    </div>
  );
...
function StickyBar({ dark, onNavigate }) {
  ...
  return (
    ...
    >
      ...
      <CTAButton size="sm" onClick={() => onNavigate("home")}>
        Start Your Page
      </CTAButton>
    </div>
  );
...
function Nav({ dark, setDark, page, setPage }) {
  ...
  const links = [
    ...
    { label: "Comparisons", p: "compare" },
    { label: "Case Studies", p: "home" },
  ];
  return (
    <nav
      style={{
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <CTAButton size="sm" onClick={() => setPage("home")}>
            Start Earning
          </CTAButton>
        </div>
      </div>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background: dark
              ? "radial-gradient(ellipse at 60% 0%, rgba(244,63,94,0.12) 0%, transparent 60%), radial-gradient(ellipse at 20% 80%, rgba(139,92,246,0.08) 0%, transparent 50%)"
              : "radial-gradient(ellipse at 60% 0%, rgba(244,63,94,0.07) 0%, transparent 60%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        >
          ...
          >
            ...
            >
              The only creator education hub built by people who've actually
              made it. Strategies, case studies, and playbooks to help you earn
              more — faster.
            </p>
            ...
            {featured.slice(0, 2).map((a, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "20px 22px",
                  cursor: "pointer",
                  transform: i === 1 ? "translateX(30px)" : "none",
                ...
                >
                  <div
                    style={{
                      ...
                      height: 8,
                      borderRadius: "50%",
                      background: catColors[a.category],
                    }}
                  />
                  <span
                    style={{
...
function ArticlePage({ article, dark, onBack, onRead }) {
  ...
  return (
    <div>
      ...
      <article
        style={{ maxWidth: 760, margin: "0 auto", padding: "0 5vw 80px" }}
      >
        <div
          style={{
            marginBottom: 20,
        ...
        <div
          style={{
            margin: "40px 0",
            padding: "32px",
            background: dark ? "rgba(244,63,94,0.08)" : "rgba(244,63,94,0.05)",
    ...
    <div>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background: dark
              ? "radial-gradient(ellipse at 50% -10%, rgba(139,92,246,0.15), transparent 60%)"
              : "radial-gradient(ellipse at 50% 0%, rgba(139,92,246,0.07), transparent 60%)",
          }}
        />
        <div style={{ position: "relative" }}>
          ...
          >
            From your first subscriber to your first $10K month. Structured
            paths, actionable guides, and strategies that actually work.
          </p>
          <div
            style={{
              display: "flex",
          ...
          >
            <CTAButton size="lg" onClick={() => setPage && setPage("home")}>
              Start Learning Free
            </CTAButton>
            <GhostButton dark={dark} onClick={() => {}}>
              View All Guides
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 5vw 80px" }}>
        ...
        >
          {[
            ["50+", "Free Guides"],
            ["12K+", "Enrolled Creators"],
            ["4.9★", "Avg Rating"],
            ["$48M", "Creator Earnings"],
          ].map(([v, l]) => (
            <div
              key={l}
              style={{
          ...
          {HUB_MODULES.map((m, i) => (
            <button
              ...
              style={{
                ...
                background:
                  activeModule === i
                    ? `linear-gradient(135deg, ${m.color
                        .replace("from-", "")
                        .replace(" to-", ", ")
                        .split(",")
                        .map((c) => {
          ...
          i !== activeModule ? null : (
            <div key={m.level}>
              <div style={{ marginBottom: 24 }}>
                ...
                >
                  Curated guides for your current stage
                </p>
              </div>
              <div
                style={{
                ...
                {m.guides.map((g, j) => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={() => setHov(true)}
                      onMouseLeave={() => setHov(false)}
                      onClick={() => onRead(ARTICLES[j % ARTICLES.length])}
                      style={{
                        padding: "24px",
                        borderRadius: 14,
                        cursor: "pointer",
            ...
            {[
              {
                name: "Luna V.",
                earned: "$85K in 6mo",
                text: "The pricing playbook alone changed everything. I stopped undervaluing myself immediately.",
                rating: 5,
              },
              {
                name: "Alex M.",
                earned: "$22K in 3mo",
                text: "No other platform actually teaches you HOW to grow. LuvlyFans Hub is genuinely unmatched.",
                rating: 5,
              },
              {
                name: "Kira S.",
                earned: "$11K first month",
                text: "I was skeptical but the case studies gave me a blueprint to follow. Results speak for themselves.",
                rating: 5,
              },
            ].map((t) => (
              <div
              ...
              >
                <div
                  style={{ color: "#f59e0b", fontSize: 14, marginBottom: 12 }}
                >
                  {"★".repeat(t.rating)}
                </div>
                <p
                      ...
                      color:
                        i === 0
                          ...
                          : dark
                            ...
                            : "rgba(0,0,0,0.6)",
                      background:
                        i === 0 ? "rgba(244,63,94,0.06)" : "transparent",
                    }}
                  >
                    {p} {i === 0 && "✓"}
                  </th>
                        ...
                        color:
                          i === 0
                            ...
                            : dark
                              ...
                              : "rgba(0,0,0,0.55)",
                        background:
                          i === 0 ? "rgba(244,63,94,0.04)" : "transparent",
                      }}
                    >
                      {v}
                    </td>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          {[
            {
              title: "Learn",
              links: ["Creator Hub", "Guides", "Case Studies", "Playbooks"],
            },
            {
              title: "Platform",
              links: ["How it Works", "Pricing", "Comparisons", "Testimonials"],
            },
            {
              title: "Company",
        ...
        >
          ...
          <div style={{ display: "flex", gap: 20 }}>
            {["Privacy Policy", "Terms of Service", "Creator Guidelines"].map(
              (l) => (
                <button
                  key={l}
                  style={{
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {page === "home" && (
        <HomePage dark={dark} onRead={handleRead} setPage={setPage} />
      )}
      ...
      {page === "hub" && (
        <HubPage dark={dark} onRead={handleRead} setPage={setPage} />
      )}
