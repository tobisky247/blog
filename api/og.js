...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt:
      "Stability comes from what you do repeatedly. Learn how to build a predictable income stream that doesn't rely on luck.",
  ...
  },
  {
    ...
    excerpt:
      "Content that converts doesn't have to be complicated. Learn what types of content drive real revenue.",
  ...
  },
  {
    ...
    excerpt:
      "Building a fanbase takes time. Learn the proven strategies that help creators grow steadily and sustainably.",
  ...
  },
  {
    ...
    excerpt:
      "Success isn't about one big win. It's about what you do every day. Learn the habits that separate growing creators from stalled ones.",
  ...
  },
  {
    ...
    excerpt:
      "What makes LuvlyFans different? Learn about our creator-first approach and why it matters for your growth.",
  ...
  },
  {
    ...
    excerpt:
      "Your profile is your storefront. Learn how to make a strong first impression that converts visitors into subscribers.",
  ...
  },
  {
    ...
    excerpt:
      "Not sure what to post? Learn how to find a content direction that feels authentic and attracts the right audience.",
  ...
  },
  {
    ...
    excerpt:
      "The first month sets the foundation. Learn exactly what to do in your first 30 days to set yourself up for success.",
  ...
  },
  {
    ...
    excerpt:
      "Pricing is about more than numbers. Learn how to price your content in a way that feels fair and maximizes your earning potential.",
...
export default async function handler(req) {
  ...
  // For all other routes, fetch and return the index.html
  const baseUrl = url.origin;
  const htmlResponse = await fetch(`${baseUrl}/index.html`);
