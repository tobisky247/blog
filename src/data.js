export const ARTICLES = [
  {
    id: 1, slug: "sustainable-monthly-income",
    ...
    readTime: "8 min", author: "QuietlyVae", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/quietly-vae.png", date: "Mar 30, 2026", featured: true, trending: true,
  ...
  },
  {
    ...
    readTime: "6 min", author: "Andi Bunni", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/Andibunni.png", date: "Mar 20, 2026", featured: true, trending: false,
  ...
  },
  {
    ...
    readTime: "10 min", author: "Loula Lou", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/Loulalou.png", date: "Mar 18, 2026", featured: false, trending: true,
    gradient: "from-violet-500 to-purple-600",
  },
  {
    id: 4, slug: "building-consistent-monthly-income",
    category: "Make Money", tag: "make-money",
    ...
    readTime: "9 min", author: "Dollia Sakura", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/Dollia Sakura.png", date: "Mar 29, 2026", featured: true, trending: true,
  ...
  },
  {
    ...
    readTime: "12 min", author: "Zozo", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/Zozo.png", date: "Mar 12, 2026", featured: false, trending: false,
    gradient: "from-emerald-500 to-teal-600",
  },
  {
    id: 7, slug: "promote-your-profile",
    category: "Growth", tag: "growth",
    ...
    readTime: "7 min", author: "Krooked Orchid", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/KrookedOrchid.png", date: "Mar 30, 2026", featured: true, trending: false,
    gradient: "from-violet-500 to-purple-600",
  },
  {
    id: 8, slug: "build-your-fanbase",
    category: "Growth", tag: "growth",
  ...
  },
  {
    ...
    readTime: "7 min", author: "Ellie Bee", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/Ellie_bee.png", date: "Apr 3, 2026", featured: true, trending: true,
    gradient: "from-rose-500 to-pink-600",
  },
  {
    id: 10, slug: "luvlyfans-standard",
    category: "Guides", tag: "guides",
    ...
    readTime: "5 min", author: "Andi Bunni", authorRole: "LuvlyFans Creator",
    authorAvatar: "/assets/creators/Andibunni.png", date: "Apr 3, 2026", featured: true, trending: false,
...
export const HUB_MODULES = [
  {
    level: "Start Here", icon: "idea", color: "from-emerald-400 to-teal-500",
    title: "I’m just starting",
    shortDesc: "Get your page set up properly and avoid common mistakes early on.",
    supportingText: "If you’re new, focus on the basics first. A clear profile, a small content base, and a simple plan will take you further than trying to do everything at once.",
    cta: "Start here",
    headerTitle: "Getting Started",
    headerDesc: "Start with the fundamentals. This is where most creators either build a strong foundation or struggle later.",
    focusPoints: [
      "Set up your profile clearly",
      "Upload your first 6–12 posts",
      "Write a simple bio that explains your content",
  ...
  {
    level: "Growth", icon: "chart-arrow-up", color: "from-violet-400 to-purple-600",
    title: "I want more subscribers",
    shortDesc: "Learn how to get seen, attract the right audience, and turn views into subscribers.",
    supportingText: "Growth comes from visibility and clarity. The goal is not just attention, but helping the right people decide to subscribe.",
    cta: "Grow my page",
    headerTitle: "Growing Your Audience",
    headerDesc: "Getting more subscribers is about being seen and making it easy for people to understand your page.",
    focusPoints: [
      "Promote your profile consistently",
      "Use Spotlight to reach new fans",
      "Share content previews outside the platform",
  ...
  {
    level: "Monetisation", icon: "earnings", color: "from-amber-400 to-orange-600",
    title: "I want to earn more",
    shortDesc: "Improve how you price, retain subscribers, and turn attention into consistent income.",
    supportingText: "Earnings usually grow when your foundation is strong. Focus on retention, clear pricing, and delivering value over time.",
    cta: "Increase earnings",
    headerTitle: "Increasing Your Earnings",
    headerDesc: "Earning more isn’t just about getting more people. It’s about making your current setup work better.",
    focusPoints: [
      "Improve retention and keep subscribers longer",
      "Use a mix of subscriptions and additional content",
      "Price your content in a way that feels sustainable",
...
export const FREE_CREATORS_DIGEST = [
  {
    ...
    featured: [
      ...
      {
        id: 2, name: "Loula Lou", handle: "@Loulalou", type: "Loula Lou",
      ...
      {
        id: 3, name: "Dollia Sakura", handle: "@PrincessDollia", type: "Dollia Sakura",
      ...
      {
        id: 4, name: "KO (Krooked Orchid)", handle: "@KrookedOrchid", type: "Krooked Orchid",
      ...
      {
        id: 5, name: "Andi Bunni", handle: "@Andibunni", type: "Andi Bunni",
      ...
      {
        id: 6, name: "Zozo", handle: "@zozonicoco", type: "Zozo",
      ...
      {
        id: 7, name: "Ellie Bee", handle: "@EllieBee", type: "Ellie Bee",
